<?php
	...
	if( isset($_POST['btn-login']) ) {
		...
		if (!$error) {
			...
			$res=mysqli_query($conn, "SELECT adminId, adminName, adminPass FROM admin WHERE adminEmail='$email'");
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-6 offset-6 reg">
		    ...
		    <input type="email" name="email" class="form-control" placeholder="名字" value="<?php echo $email; ?>" maxlength="40" />

			<span class="text-danger"><?php echo $emailError; ?></span>

			<input type="password" name="pass" class="form-control" placeholder="密码" maxlength="15" />
			
			<span class="text-danger"><?php echo $passError; ?></span>

			<hr />

			<button class="btn btn-block btn-warning" type="submit" name="btn-login">登记</button>
